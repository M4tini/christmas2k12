...
var tini_width = 850,
    tini_height = 580,
    tini_top = height / 2 - tini_height / 2,
    tini_left = width / 2 - tini_width / 2,
    tini_margin = 10, // draw outside the viewing area
    tini_style = tini.style;
...
// make nice
document.title = 'Christmas2k12 | M4tini';
...
var sini_wavelength = 4.46,
    sini_amplitude = 20,
    sini = [],
    sin_pi = Math.floor(Math.PI * 2 * sini_wavelength),
    i = sin_pi - 1;
do
{
...
var sin2_wavelength = 20,
    sin2_amplitude = 20,
    sin2 = [],
    sin2_pi = Math.floor(Math.PI * 2 * sin2_wavelength),
    i = sin2_pi - 1;
do
{
...
var tini_x = tini_width,
    ...
    scroller  = [],
    scroller2 = [],
    scroll_text  = '  Christmas | a quick HTML5 demo to wish you a Happy   | ',
    scroll_text2 = '       2k12 |                                New Year  | ';
...
var scroll_visible = 0,
    scroll_length = scroll_text.length;
function addLetter()
{
...
function tiniLoop()
{
    ...
    */
    ...
    var snow_x = tini_width * .75,
        snow_y = tini_height - 80,
        snow_y_headjump = snow_y + sini[sini_index],
        snow_y_bodyjump = snow_y + sini[sini_index] * .8,
        two_pi = Math.PI * 2;
    // body
    gradient = ctx.createRadialGradient(snow_x, snow_y_bodyjump, 0, snow_x, snow_y_bodyjump, 60);
    ...
    ctx.closePath();
    ctx.fill();
    gradient = ctx.createRadialGradient(snow_x, snow_y_headjump - 80, 0, snow_x, snow_y_headjump - 80, 50);
    gradient.addColorStop(0, 'rgb(255,255,255)');
    gradient.addColorStop(1, 'rgb(100,100,100)');
    ctx.fillStyle = gradient;
    ctx.beginPath();
    ...
    ctx.fill();
    // nose
    gradient = ctx.createRadialGradient(snow_x - 7, snow_y_headjump - 70, 0, snow_x - 7, snow_y_headjump - 70, 14);
